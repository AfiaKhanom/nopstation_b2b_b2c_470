...
public class ERPIntegrationCorePlugin : BasePlugin, IMiscPlugin, IAdminMenuPlugin, INopStationPlugin
{
    ...
    public List<KeyValuePair<string, string>> PluginResouces()
    {
        return new List<KeyValuePair<string, string>>
        {
            ...
            new ("Plugin.Misc.NopStation.ERPIntegrationCore.Admin.Configuration.Fields.SelectedErpIntegrationPluginForAccount", "Account Sync"),
            new ("Plugin.Misc.NopStation.ERPIntegrationCore.Admin.Configuration.Fields.SelectedErpIntegrationPluginForAccount.Hint", "Select an ERP Integration Plugin for Account Sync from these System Names."),
            new ("Plugin.Misc.NopStation.ERPIntegrationCore.Admin.Configuration.Fields.SelectedErpIntegrationPluginForProduct", "Product Sync"),
            new ("Plugin.Misc.NopStation.ERPIntegrationCore.Admin.Configuration.Fields.SelectedErpIntegrationPluginForProduct.Hint", "Select an ERP Integration Plugin for Product Sync from these System Names."),
            new ("Plugin.Misc.NopStation.ERPIntegrationCore.Admin.Configuration.Fields.SelectedErpIntegrationPluginForOrder", "Order Sync"),
            new ("Plugin.Misc.NopStation.ERPIntegrationCore.Admin.Configuration.Fields.SelectedErpIntegrationPluginForOrder.Hint", "Select an ERP Integration Plugin for Order Sync from these System Names."),
            new ("Plugin.Misc.NopStation.ERPIntegrationCore.Admin.Configuration.Fields.SelectedErpIntegrationPluginForInvoice", "Invoice Sync"),
            new ("Plugin.Misc.NopStation.ERPIntegrationCore.Admin.Configuration.Fields.SelectedErpIntegrationPluginForInvoice.Hint", "Select an ERP Integration Plugin for Invoice Sync from these System Names."),
            new ("Plugin.Misc.NopStation.ERPIntegrationCore.Admin.Configuration.Fields.SelectedErpIntegrationPluginForStock", "Stock Sync"),
            new ("Plugin.Misc.NopStation.ERPIntegrationCore.Admin.Configuration.Fields.SelectedErpIntegrationPluginForStock.Hint", "Select an ERP Integration Plugin for Stock Sync from these System Names."),
            new ("Plugin.Misc.NopStation.ERPIntegrationCore.Admin.Configuration.Fields.SelectedErpIntegrationPluginForSpecialPrice", "Special Price Sync"),
            new ("Plugin.Misc.NopStation.ERPIntegrationCore.Admin.Configuration.Fields.SelectedErpIntegrationPluginForSpecialPrice.Hint", "Select an ERP Integration Plugin for Special price er Sync from these System Names."),
            new ("Plugin.Misc.NopStation.ERPIntegrationCore.Admin.Configuration.Fields.SelectedErpIntegrationPluginForGroupPrice", "Group price Sync"),
            new ("Plugin.Misc.NopStation.ERPIntegrationCore.Admin.Configuration.Fields.SelectedErpIntegrationPluginForGroupPrice.Hint", "Select an ERP Integration Plugin for Group price Sync from these System Names."),
            new ("Plugin.Misc.NopStation.ERPIntegrationCore.Admin.Configuration.Fields.SelectedErpIntegrationPluginForShiptoAddress", "ShiptoAddress Sync"),
            new ("Plugin.Misc.NopStation.ERPIntegrationCore.Admin.Configuration.Fields.SelectedErpIntegrationPluginForShiptoAddress.Hint", "Select an ERP Integration Plugin for Order Sync from these System Names."),
            new ("Plugin.Misc.NopStation.ERPIntegrationCore.Admin.Configuration.Fields.UseSingleIntegrationPluginForAllSync", "Use Single Integration For All"),
            new ("Plugin.Misc.NopStation.ERPIntegrationCore.Admin.Configuration.Fields.UseSingleIntegrationPluginForAllSync.Hint", "Select single integration for All kind of Sync."),
