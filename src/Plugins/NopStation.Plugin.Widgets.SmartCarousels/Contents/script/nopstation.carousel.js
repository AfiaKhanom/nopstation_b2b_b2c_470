...
var SmartCarousel = {
  ...
  chek_element_on_screen: function (elem) {
    ...
    // Add a 100px buffer before the element enters the screen
    return ((elemBottom <= docViewBottom + 100 && elemBottom >= docViewTop) ||
      (elemTop <= docViewBottom + 100 && elemTop >= docViewTop));
  },
  ...
  load_carousel_details: function (carouselid) {
    $.ajax({
      ...
      success: function (response) {
        ...
        currentElem.addClass('carousel-grid-container');
