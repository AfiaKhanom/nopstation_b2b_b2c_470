    ...
    public class B2BB2CFeaturesController : NopStationAdminController
    {
        ...
        public async Task<IActionResult> Configure(ConfigurationModel model)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                await _settingService.SaveSettingOverridablePerStoreAsync(settings, x => x.MaxERPIntegrationOrderPlaceReties, model.MaxERPIntegrationOrderPlaceReties_OverrideForStore, storeScope, false);
