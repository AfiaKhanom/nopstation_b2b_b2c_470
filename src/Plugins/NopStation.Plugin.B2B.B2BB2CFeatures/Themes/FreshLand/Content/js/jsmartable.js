$.fn.jsmartable = function(options){
    ...
    var settings = $.extend({
        ...
        iconPlus: '<i class="icon icon-plus text-info"></i>',
        iconMinus: '<i class="icon icon-flex-minus text-danger"></i>',
        allExpended: false
    }, options);
    ...
    $('body').on('click', '.jsmartable-collapse:not(.jsmartable-collapsed-on)', function(e) {
      $(this).addClass("jsmartable-collapsed-on");
        var $this = $(this);
    ...
    $('body').on('click', '.jsmartable-collapsed-on', function(e) {
      $(this).removeClass("jsmartable-collapsed-on");
        var $this = $(this);
        var jsmartableRow = $this.closest("td").closest("tr").next();
  ...
  $(this).addClass("jsmatable-initialized");
};
